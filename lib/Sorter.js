    ...
    grid.rows.sort(function (a, b) {
      ...
      for (i=0; i<this.columnIndex.length; i++) {
        ...
        if (Array.isArray(this.columnSortBy[i])) {
          value_a = this.columnSortBy[i].indexOf(a.getCell(this.columnIndex[i]).getValue());
          value_b = this.columnSortBy[i].indexOf(b.getCell(this.columnIndex[i]).getValue());
          ...
          value_a = a.getCell(this.columnIndex[i]).getValue();
          value_b = b.getCell(this.columnIndex[i]).getValue();
          if (value_a != value_b) {                
